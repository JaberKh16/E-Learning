<?php require_once("insert_course_lan_data.php"); ?>
...
<head>
    ...
    <title> Programming Language Course </title>
    <!-- CSS File -->
...
<!-- Modal -->
<div class="modal fade" id="prog_lan_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <form action = "insert_course_lan_data.php" method = "POST">
...
<form action = "update_course_lan_data.php" method = "POST">
...
<div class="modal fade" id="delete_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
         ...
         <form action="delete_course_lan_data.php" method="POST">
            <div class="modal-body">
       ...
       <div class="card">
         ...
         <div class="card-body">
                ...
                <!-- Button trigger modal -->
                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#prog_lan_data">
                     Add Course Data
                 </button>
       ...
       <div class="card">
         ...
         <div class="card-body">
          ...
          <?php 
                 ...
                 $query = "SELECT * FROM programming_language_course";
