...
<!-- Modal -->
<div class="modal fade" id="marketing_course_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <form action = "insert_course_marketing_data.php" method = "POST">
...
<form action = "update_course_marketing_data.php" method = "POST">
...
<div class="modal fade" id="delete_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
         ...
         <form action="delete_course_marketing_data.php" method="POST">
            <div class="modal-body">
       ...
       <div class="card">
         ...
         <div class="card-body">
                ...
                <!-- Button trigger modal -->
                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#marketing_course_data">
                     Add Course Data
                 </button>
       ...
       <div class="card">
         ...
         <div class="card-body">
          ...
          <?php 
                 ...
                 $query = "SELECT * FROM marketing_courses";
