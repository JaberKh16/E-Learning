...
<?php
  ...
  //create user_table accelaration table ----------------------------------------------
	$sql = "CREATE TABLE IF NOT EXISTS `eLearning_System` .`users`
    (
		user_user_id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,
		user_user_name VARCHAR(255),
		user_card_no INTEGER NOT NULL,
		user_pack_sal_id INTEGER NOT NULL,
		user_pack_free_id INTEGER NOT NULL,
		user_pack_coup_id INTEGER NOT NULL,
